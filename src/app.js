...
========================================
🚨 AM/PM RESOLUTION (CRITICAL — सर्वात महत्वाचा rule)
========================================

⚠️ कॉलर जेव्हा सिर्फ आकडा बोलतो (AM/PM न सांगता), तेव्हा हे rule वापरा:

**डॉक्टर सकाळी (AM) कधीच उपलब्ध नाहीत. म्हणून सर्व आकडे PM समजा:**

| कॉलर बोलतो | ✅ बरोबर अर्थ | ❌ चुकीचा अर्थ |
|---|---|---|
| "एक बजे" / "एक वाजता" | 1:00 PM (दुपारी) | 1:00 AM ❌ |
| "दो बजे" / "दोन वाजता" | 2:00 PM (दुपारी) | 2:00 AM ❌ |
| "तीन बजे" | 3:00 PM (दुपारी) - boundary | 3:00 AM ❌ |
| "बारह बजे" / "बारा वाजता" | 12:00 PM (दुपारी) | 12:00 AM ❌ |
| "डेढ़" / "दीड" | 1:30 PM (दुपारी) | - |
| "ढाई" / "अडीच" | 2:30 PM (दुपारी) | - |
| "छह बजे" / "सहा" | 6:00 PM (संध्याकाळी) | 6:00 AM ❌ |
| "सात बजे" | 7:00 PM (संध्याकाळी) | 7:00 AM ❌ |
| "आठ बजे" | 8:00 PM (रात्री) | 8:00 AM ❌ |
| "नऊ बजे" | 9:00 PM (रात्री) | 9:00 AM ❌ |

🚨 IMPORTANT: 
- "एक बजे" = 1:00 PM = ✅ VALID (12-3 PM range मध्ये)
- "दो बजे" = 2:00 PM = ✅ VALID (12-3 PM range मध्ये)
- "एक वाजता" boluna VALID — reject करू नका! Tool ला "01:00 PM" pass करा.
- "दोन वाजता" boluna VALID — reject करू नका! Tool ला "02:00 PM" pass करा.
...
✅ नेहमी:
- सिर्फ "एक" / "दो" → automatically PM समजा (दुपारी)
- VALID time असेल तर confirm करा: "नक्की. म्हणजे उद्या दुपारी एक वाजता, बरोबर आहे का?"
...
### STEP 2: वेळ check (AM/PM resolution नंतर)
**FIRST: सिर्फ आकडा असेल तर AM/PM rules लावा (वर पहा)**

valid windows: 12:00 PM - 3:00 PM AND 6:00 PM - 9:00 PM

INVALID time messages:
- 3:00 PM - 6:00 PM दरम्यान: "माफ करा, त्या वेळी डॉक्टर उपलब्ध नाहीत. दुपारी बारा ते तीन, आणि संध्याकाळी सहा ते नऊ वाजेपर्यंत उपलब्ध आहेत. कोणत्या वेळी यायचे आहे?"
- 9 PM नंतर: तसेच
- 12 PM आधी (सकाळी): "डॉक्टर सकाळी उपलब्ध नाहीत. दुपारी बारा ते तीन, आणि संध्याकाळी सहा ते नऊ वाजेपर्यंत उपलब्ध आहेत."
...
### दिवसाचे भाग
- सकाळी = 12 PM आधी (डॉक्टर उपलब्ध नाहीत)
- दुपारी = 12 PM-4 PM
...
- "एक बजे" → "नक्की. म्हणजे उद्या दुपारी एक वाजता, बरोबर आहे का?" (1 PM as it's in clinic hours)
- "दो बजे" → "नक्की. म्हणजे उद्या दुपारी दोन वाजता, बरोबर आहे का?" (2 PM as it's in clinic hours)
...
🔒 Never
========================================
- हिंदीत reply / English reply / हिंदी मराठीत mix
...
- 🔒 फक्त मराठी reply
- सिर्फ आकडा → PM समजा (12, 1, 2 = दुपारी; 6, 7 = संध्याकाळी; 8, 9 = रात्री)
  ...
  if (name === 'book_appointment') {
    try {
      const payload = {
        ...
        // FROM phone (caller / patient) — sent under multiple names
      ...
      // Detailed error logging — shows actual reason for 4xx/5xx
      if (err.response) {
        ...
        console.error('[BOOK_APPOINTMENT] Headers:', err.response.headers);
      } else if (err.request) {
...
wss.on('connection', (ws, req) => {
  ...
  ws.on('message', async (data) => {
    try {
      ...
      // ----------------------------------------------------------
      // START_CALL — capture phone numbers (FIXED for Exotel/voip)
      // ----------------------------------------------------------
      if (message.type === 'start_call') {
        ...
        // ⚡ KEY FIX: Exotel/Twilio-style providers nest phone info under data.voip
        const voip = d.voip || {};

        // FROM phone (caller / patient)
        callContext.from_phone =
          voip.from ||              // ← Exotel/voip structure (PRIMARY)
          d.from_phone ||
          d.from ||
          d.FromPhone ||
          d.fromPhone ||
        ...
        // TO phone (clinic / business number called)
        callContext.to_phone =
          voip.to ||                // ← Exotel/voip structure (PRIMARY)
          d.to_phone ||
          d.to ||
          d.ToPhone ||
          d.toPhone ||
